                                ...
                                <table class="table table-bordered" id="personelTeamTable">
                                    ...
                                    <input type="hidden" name="id_equipment" value="{{ $equipmentId }}">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="text" class="form-control text-center" name="q24[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="text" class="form-control text-center" name="q25[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="text" class="form-control text-center" name="q26[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="text" class="form-control text-center" name="q27[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="text" class="form-control text-center" name="q28[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control text-center" name="q29[]" value=""></td>
                                                <td class="text-center"><input type="text" class="form-control text-center" name="q29[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control text-center" name="q30[]" value=""></td>
                                                <td class="text-center"><input type="text" class="form-control text-center" name="q30[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control text-center" name="q31[]" value=""></td>
                                                <td class="text-center"><input type="text" class="form-control text-center" name="q31[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control text-center" name="q32[]" value=""></td>
                                                <td class="text-center"><input type="text" class="form-control text-center" name="q32[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control text-center" name="q33[]" value=""></td>
                                                <td class="text-center"><input type="text" class="form-control text-center" name="q33[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control text-center" name="q34[]" value=""></td>
                                                <td class="text-center"><input type="text" class="form-control text-center" name="q34[]"></td>
                                            </tr>
