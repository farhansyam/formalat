        ...
        <section>
         ...
         <input type="hidden" required name="id" value="{{ $coldStorage->id }}">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control text-center" value="{{ isset($q1Array[0]) ? $q1Array[0] : '' }}"  name="q1[]" readonly></td>
                                        <td><input type="text" class="form-control text-center" value="{{ isset($q1Array[1]) ? $q1Array[1] : '' }}"  name="q1[]" readonly></td>
                                        <td class="text-center"><input type="text" class="form-control text-center" value="{{ isset($q1Array[2]) ? $q1Array[2] : '' }}"  name="q1[]" readonly></td>
                                    </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="text" class="form-control text-center"readonly value="{{ isset($q16Array[2]) ? $q16Array[2] : '' }}"  name="q16[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="text" class="form-control text-center"readonly value="{{ isset($q24Array[2]) ? $q24Array[2] : '' }}"  name="q24[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="text" class="form-control text-center"readonly value="{{ isset($q25Array[2]) ? $q25Array[2] : '' }}"  name="q25[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="text" class="form-control text-center"readonly value="{{ isset($q26Array[2]) ? $q26Array[2] : '' }}"  name="q26[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="text" class="form-control text-center"readonly value="{{ isset($q27Array[2]) ? $q27Array[2] : '' }}"  name="q27[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="text" class="form-control text-center"readonly value="{{ isset($q28Array[2]) ? $q28Array[2] : '' }}"  name="q28[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="text" class="form-control text-center"readonly value="{{ isset($q29Array[2]) ? $q29Array[2] : '' }}"  name="q29[]"></td>
                                            </tr>

                                            <tr>
                                             
                                                <td>Check TXV function</td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q30Array[0]) ? $q30Array[0] : '' }}"  name="q30[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q30Array[1]) ? $q30Array[1] : '' }}"  name="q30[]" ></td>
                                                <td class="text-center"><input type="text" class="form-control text-center"readonly value="{{ isset($q30Array[2]) ? $q30Array[2] : '' }}"  name="q30[]"></td>
                                            </tr>

                                            <tr>
                                             
                                                <td>Check defrost function</td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q31Array[0]) ? $q31Array[0] : '' }}"  name="q31[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q31Array[1]) ? $q31Array[1] : '' }}"  name="q31[]" ></td>
                                                <td class="text-center"><input type="text" class="form-control text-center"readonly value="{{ isset($q31Array[2]) ? $q31Array[2] : '' }}"  name="q31[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="text" class="form-control text-center"readonly value="{{ isset($q32Array[2]) ? $q32Array[2] : '' }}"  name="q32[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="text" class="form-control text-center"readonly value="{{ isset($q33Array[2]) ? $q33Array[2] : '' }}"  name="q33[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><input type="text" class="form-control text-center"readonly value="{{ isset($q34Array[2]) ? $q34Array[2] : '' }}"  name="q34[]"></td>
                                            </tr>
                                ...
                                <table class="table table-bordered" id="personelTeamTable">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control text-center"readonly value="{{ isset($q36Array[0]) ? $q36Array[0] : '' }}"  name="q36[]"></td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td>Fan Cond.Model No :</td>
                                        <td><input type="text" class="form-control text-center"readonly value="{{ isset($q37Array[0]) ? $q37Array[0] : '' }}"  name="q37[]"></td>
                                    </tr>
                                    <tr>
                                        <td>4</td>
                                        <td>Fan Evap.Model No :</td>
                                        <td><input type="text" class="form-control text-center"readonly value="{{ isset($q38Array[0]) ? $q38Array[0] : '' }}"  name="q38[]"></td>
                                    </tr>
                                    <tr>
                                        <td>5</td>
                                    ...
                                    <thead>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q40Array[2]) ? $q40Array[2] : '' }}"  name="q40[]"></td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>Suction Press</td>
                                                <td></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q41Array[0]) ? $q41Array[0] : '' }}"  name="q41[]"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q42Array[0]) ? $q42Array[0] : '' }}"  name="q42[]"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q43Array[2]) ? $q43Array[2] : '' }}"  name="q43[]"></td>
                                            </tr>
                                            <tr>
                                                <td>5</td>
                                                ...
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q44Array[2]) ? $q44Array[2] : '' }}"  name="q44[]"></td>
                                            </tr>
                                            <tr>
                                                <td>6</td>
                                                <td>Voltage</td>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q45Array[0]) ? $q45Array[0] : '' }}"  name="q45[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q45Array[1]) ? $q45Array[1] : '' }}"  name="q45[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q45Array[2]) ? $q45Array[2] : '' }}"  name="q45[]">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q45Array[3]) ? $q45Array[3] : '' }}"  name="q45[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q45Array[4]) ? $q45Array[4] : '' }}"  name="q45[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q45Array[5]) ? $q45Array[5] : '' }}"  name="q45[]">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q46Array[0]) ? $q46Array[0] : '' }}"  name="q46[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q46Array[1]) ? $q46Array[1] : '' }}"  name="q46[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q46Array[2]) ? $q46Array[2] : '' }}"  name="q46[]">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q46Array[3]) ? $q46Array[3] : '' }}"  name="q46[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q46Array[4]) ? $q46Array[4] : '' }}"  name="q46[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q46Array[5]) ? $q46Array[5] : '' }}"  name="q46[]">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q46Array[6]) ? $q46Array[6] : '' }}"  name="q46[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q46Array[7]) ? $q46Array[7] : '' }}"  name="q46[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q46Array[8]) ? $q46Array[8] : '' }}"  name="q46[]">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q47Array[0]) ? $q47Array[0] : '' }}"  name="q47[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q47Array[1]) ? $q47Array[1] : '' }}"  name="q47[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q47Array[2]) ? $q47Array[2] : '' }}"  name="q47[]">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q47Array[3]) ? $q47Array[3] : '' }}"  name="q47[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q47Array[4]) ? $q47Array[4] : '' }}"  name="q47[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q47Array[5]) ? $q47Array[5] : '' }}"  name="q47[]">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q47Array[6]) ? $q47Array[6] : '' }}"  name="q47[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q47Array[7]) ? $q47Array[7] : '' }}"  name="q47[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q47Array[8]) ? $q47Array[8] : '' }}"  name="q47[]">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q48Array[0]) ? $q48Array[0] : '' }}"  name="q48[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q48Array[1]) ? $q48Array[1] : '' }}"  name="q48[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q48Array[2]) ? $q48Array[2] : '' }}"  name="q48[]">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q48Array[3]) ? $q48Array[3] : '' }}"  name="q48[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q48Array[4]) ? $q48Array[4] : '' }}"  name="q48[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q48Array[5]) ? $q48Array[5] : '' }}"  name="q48[]">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q48Array[6]) ? $q48Array[6] : '' }}"  name="q48[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q48Array[7]) ? $q48Array[7] : '' }}"  name="q48[]">
                                                    <input type="text" class="form-control text-center"readonly value="{{ isset($q48Array[8]) ? $q48Array[8] : '' }}"  name="q48[]">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>3/4</td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q49Array[0]) ? $q49Array[0] : '' }}"  name="q49[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q49Array[1]) ? $q49Array[1] : '' }}"  name="q49[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>Clean</td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q50Array[0]) ? $q50Array[0] : '' }}"  name="q50[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q50Array[1]) ? $q50Array[1] : '' }}"  name="q50[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>Clean</td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q51Array[0]) ? $q51Array[0] : '' }}"  name="q51[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q51Array[1]) ? $q51Array[1] : '' }}"  name="q51[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>Clean</td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q52Array[0]) ? $q52Array[0] : '' }}"  name="q52[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q52Array[1]) ? $q52Array[1] : '' }}"  name="q52[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>Ok / Not Ok</td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q53Array[0]) ? $q53Array[0] : '' }}" name="q53[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q53Array[1]) ? $q53Array[1] : '' }}" name="q53[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q54Array[0]) ? $q54Array[0] : '' }}"  name="q54[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q54Array[1]) ? $q54Array[1] : '' }}"  name="q54[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q54Array[2]) ? $q34Array[2] : '' }}"  name="q54[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q55Array[0]) ? $q55Array[0] : '' }}"  name="q55[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q55Array[1]) ? $q55Array[1] : '' }}"  name="q55[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q55Array[2]) ? $q55Array[2] : '' }}"  name="q55[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q56Array[0]) ? $q56Array[0] : '' }}"  name="q56[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q56Array[1]) ? $q56Array[1] : '' }}"  name="q56[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q56Array[2]) ? $q56Array[2] : '' }}"  name="q56[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q57Array[0]) ? $q57Array[0] : '' }}"  name="q57[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q57Array[1]) ? $q57Array[1] : '' }}"  name="q57[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q57Array[2]) ? $q57Array[2] : '' }}"  name="q57[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q58Array[0]) ? $q58Array[0] : '' }}" name="q58[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q58Array[1]) ? $q58Array[1] : '' }}" name="q58[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q58Array[2]) ? $q58Array[2] : '' }}" name="q58[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q59Array[0]) ? $q59Array[0] : '' }}"  name="q59[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q59Array[1]) ? $q59Array[1] : '' }}"  name="q59[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q59Array[2]) ? $q59Array[2] : '' }}"  name="q59[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q60Array[0]) ? $q60Array[0] : '' }}"  name="q60[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q60Array[1]) ? $q60Array[1] : '' }}"  name="q60[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q60Array[2]) ? $q60Array[2] : '' }}"  name="q60[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q61Array[0]) ? $q61Array[0] : '' }}"  name="q61[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q61Array[1]) ? $q61Array[1] : '' }}"  name="q61[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q61Array[2]) ? $q61Array[2] : '' }}"  name="q61[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q62Array[0]) ? $q62Array[0] : '' }}"  name="q62[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q62Array[1]) ? $q62Array[1] : '' }}"  name="q62[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q62Array[2]) ? $q62Array[2] : '' }}"  name="q62[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>Fan Condition</td>
                                                <td></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q63Array[0]) ? $q63Array[0] : '' }}" name="q63[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q63Array[1]) ? $q63Array[1] : '' }}" name="q63[]"></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q63Array[2]) ? $q63Array[2] : '' }}" name="q63[]"></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>Running Hours</td>
                                                <td></td>
                                                <td><input type="text" class="form-control text-center"readonly value="{{ isset($q64Array[0]) ? $q64Array[0] : '' }}"  name="q64[]"></td>
                                            </tr>
                                        </tbody>
                                </table>
                        </div>
