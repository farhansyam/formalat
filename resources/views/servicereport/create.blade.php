    ...
    @csrf
              <div class="row">
                <div class="col-md-4 mb-3">
                  ...
                  <input type="text" name="customer" class="form-control" id=""  value=""
                    required="">
...
<script>
        ...
        if (radioOther.checked) {
            ...
            otherJenisSurveyInput.style.display = 'none';
                  ...
                  <div class="row">
                    ...
                    <div class="form-check">
                        <input type="radio" name="defect_level" value="Medium" class="form-check-input" id="radio2_column1">
                        <label class="form-check-label" for="radio2_column1">&nbsp;&nbsp;Medium</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" name="defect_level" value="Low" class="form-check-input" id="radio3_column1">
    ...
    <div class="form-check">
        <input type="radio" name="defect_type" value="Area sulit dijangkau / Hard Access" class="form-check-input" id="radio2">
        <label class="form-check-label" for="radio2">Area sulit dijangkau / Hard Access</label>
    </div>
    <div class="form-check">
        <input type="radio" name="defect_type" value="Sumber kontaminasi produk" class="form-check-input" id="radio3">
        <label class="form-check-label" for="radio3">Sumber kontaminasi produk</label>
    </div>
    <div class="form-check">
        <input type="radio" name="defect_type" value="Mengurangi kualitas" class="form-check-input" id="radio4">
