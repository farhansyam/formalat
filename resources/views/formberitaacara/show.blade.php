    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <tr>
            ...
            <td><input disabled type="text" class="form-control" name="deskripsilist[]"></td>
            <td><input disabled type="text" class="form-control" name="modelpart[]"></td>
            <td><input disabled type="number" class="form-control" name="qty[]"></td>
            <td><input disabled type="text" class="form-control" name="keterangan[]"></td>
