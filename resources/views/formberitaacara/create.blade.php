            ...
            <form action="{{ route('formberitaacara.store') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  ...
                  <input type="radio" name="name_plate" value="ada" class="form-check-input" id="" name="jenis_survey">
                  <label class="form-check-label" for="">&nbsp; &nbsp;Ada</label>

                  <input type="radio" name="name_plate" value="tidak ada" class="form-check-input" id="" name="jenis_survey">
